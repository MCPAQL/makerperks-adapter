...
- [x] 3.1 `openspec validate add-flow-export --strict`; typecheck/lint/both test layers green.
- [x] 3.2 Archive into `openspec/specs/` (`flow-export` created); fill the spec `Purpose`.
